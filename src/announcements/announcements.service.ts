  ...
  private getAnnouncementTypeMeta(
    ...
    > = {
      [AnnouncementType.GENERAL]: {
        label: 'Announcement',
        heading: "A Message from Corrado's Restaurant",
        emoji: '📢',
        ctaText: "Visit Corrado's Restaurant",
        accentColor: '#C87941',
      },
      [AnnouncementType.PROMOTION]: {
        label: 'Special Offer',
        heading: "Exclusive Deal at Corrado's Restaurant!",
        emoji: '🎁',
      ...
      [AnnouncementType.CLOSURE]: {
        ...
        heading: "Important Update from Corrado's Restaurant",
        emoji: '⚠️',
      ...
      [AnnouncementType.COMMUNITY]: {
        ...
        heading: "From Our Community at Corrado's Restaurant",
        emoji: '🤝',
        ctaText: 'Learn More',
        accentColor: '#3498DB',
      },
      [AnnouncementType.HOLIDAY]: {
        ...
        heading: "Happy Holidays from Corrado's Restaurant!",
        emoji: '🎄',
