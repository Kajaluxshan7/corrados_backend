...
export class MailService {
  ...
  async sendResetPasswordEmail(
    ...
    const mailOptions = {
      from: this.emailFrom,
      to,
      subject: 'Reset your Corrados Admin password',
      text: `Hello ${displayName},\n\nWe received a request to reset your password for Corrados Admin. Use the link below to set a new password. This link will expire in 1 hour.\n\n${resetUrl}\n\nIf you did not request a password reset, you can safely ignore this email.`,
      html: `<p>Hello ${displayName},</p><p>We received a request to reset your Corrados Admin password. Click the link below to reset it - the link expires in 1 hour.</p><p><a href="${resetUrl}">${resetUrl}</a></p><p>If you did not request this, please ignore this email.</p>`,
    } as any;
  ...
  async sendPasswordChangedConfirmation(to: string, name: string | undefined) {
    ...
    const mailOptions = {
      from: this.emailFrom,
      to,
      subject: 'Your Corrados Admin password was changed',
      text: `Hello ${displayName},\n\nThis is a confirmation that your Corrados Admin password was successfully changed. If you did not perform this action, please contact support immediately.`,
      html: `<p>Hello ${displayName},</p><p>Your Corrados Admin password was successfully changed. If you did not perform this action, please contact support immediately.</p>`,
    } as any;
    ...
    const mailOptions = {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <h2 style="color: #d4a574;">Welcome to Corrado's Restaurant Admin!</h2>
          <p>Hello <strong>${displayName}</strong>,</p>
          <p>Thank you for joining the Corrado's Restaurant Admin Dashboard. To complete your registration, please verify your email address by clicking the button below:</p>
    ...
    const mailOptions = {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <p>Hello <strong>${displayName}</strong>,</p>
          <p>Great news! Your email address has been successfully verified. You can now log in to your Corrado's Restaurant Admin Dashboard.</p>
          <div style="text-align: center; margin: 30px 0;">
