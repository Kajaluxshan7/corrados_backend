...
export class NewsletterService {
  ...
  constructor(
    ...
    this.emailFrom =
      ...
      "Corrado's Restaurant <" + getRequiredEnv('EMAIL_FROM') + '>';
  ...
  async sendPromoCode(
    id: string,
  ): Promise<{ message: string; promoCode: string }> {
    let savedEmail = '';
    let savedCode = '';
  ...
  private getEventTypeMeta(eventType: string): {
    ...
    > = {
      live_music: {
        label: 'Live Music',
        heading: "Live Music Night at Corrado's Restaurant!",
        emoji: '🎵',
        ctaText: 'See the Lineup',
      },
      sports_viewing: {
        label: 'Sports Viewing',
        heading: "Game Day at Corrado's Restaurant!",
        emoji: '🏆',
        ctaText: 'Join the Watch Party',
      },
      trivia_night: {
        label: 'Trivia Night',
        heading: "Trivia Night at Corrado's Restaurant!",
        emoji: '🧠',
        ctaText: 'Gather Your Team',
      },
      karaoke: {
        label: 'Karaoke Night',
        heading: "Karaoke Night at Corrado's Restaurant!",
        emoji: '🎤',
        ctaText: 'Warm Up Your Vocals',
      },
      private_party: {
        label: 'Special Party',
        heading: "Special Party at Corrado's Restaurant!",
        emoji: '🥂',
        ctaText: 'View Event Details',
      },
      special_event: {
        label: 'Special Event',
        heading: "Something Special at Corrado's Restaurant!",
        emoji: '🎉',
        ctaText: 'View Event Details',
      },
    };
    ...
    return (
      meta[eventType] || {
        label: 'New Event',
        heading: "New Event at Corrado's Restaurant!",
        emoji: '🎉',
        ctaText: 'View Event Details',
      }
    );
  ...
  private getSpecialTypeMeta(
    ...
    > = {
      daily: {
        ...
        heading: dayName
          ? isLateNight
            ? `${dayName} Late Night Special at Corrado's Restaurant!`
            : `${dayName} Special at Corrado's Restaurant!`
          : isLateNight
            ? "Late Night Special at Corrado's Restaurant!"
            : "New Daily Special at Corrado's Restaurant!",
        emoji: isLateNight ? '🌙' : '📅',
        ctaText: "View Today's Special",
      },
      game_time: {
        label: 'Game Time Special',
        heading: "Game Time Special at Corrado's Restaurant!",
        emoji: '🏈',
        ctaText: 'View Game Time Deal',
      },
      day_time: {
        label: 'Day Time Special',
        heading: "Day Time Special at Corrado's Restaurant!",
        emoji: '☀️',
        ctaText: 'View Day Time Deal',
      },
      chef: {
        label: "Chef's Special",
        heading: "New Chef's Special at Corrado's Restaurant!",
        emoji: '👨‍🍳',
        ctaText: "See the Chef's Pick",
      },
      seasonal: {
        label: 'Seasonal Special',
        heading: "New Seasonal Special at Corrado's Restaurant!",
        emoji: '🍂',
    ...
    return (
      meta[specialType] || {
        label: 'New Special',
        heading: "New Special at Corrado's Restaurant!",
        emoji: '⭐',
  ...
  private async sendPromoEmail(subscriber: Subscriber): Promise<void> {
    ...
    await this.sendMail(
      subscriber.email,
      "Your Complimentary Appetizer Promo Code - Corrado's Restaurant 🍺",
      html,
    );
  }
...
<body style="margin: 0; padding: 0; background-color: #EDE0D0; font-family: 'Segoe UI', -apple-system, Helvetica, Arial, sans-serif;">
  <div style="display: none; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #EDE0D0;">Your complimentary appetizer promo code from Corrado's Restaurant&#847; &#847; &#847;</div>
          ...
          <tr>
            <td class="content-pad" style="background-color: #FFFCF8; padding: 24px 40px 0;">
              <p style="margin: 0; font-size: 15px; line-height: 1.75; color: #5C4033;">
                You are eligible for a complimentary appetizer at Corrado's Restaurant.<br />
              ...
              <table role="presentation" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="border-radius: 10px; background-color: #2A1509;" align="center">
                    <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="${this.frontendUrl}" style="height:48px;v-text-anchor:middle;width:220px;" arcsize="21%" fillcolor="#2A1509" stroke="f"><v:textbox inset="0,0,0,0"><center style="font-size:15px;font-weight:700;color:#F5EFE6;font-family:Arial,sans-serif;">Visit Corrado's Restaurant</center></v:textbox></v:roundrect><![endif]-->
                    <!--[if !mso]><!-->
                    <a href="${this.frontendUrl}" style="display: inline-block; padding: 14px 40px; background-color: #2A1509; color: #F5EFE6; font-size: 15px; font-weight: 700; border-radius: 10px; text-decoration: none; letter-spacing: 0.3px; font-family: 'Segoe UI', Arial, sans-serif; text-align: center;">Visit Corrado's Restaurant&nbsp;&rarr;</a>
                    <!--<![endif]-->
                  </td>
                </tr>
              </table>
                ...
                <tr>
                  <td align="center" style="padding-top: 2px;">
                    <p style="margin: 0; font-size: 11px; line-height: 1.6; color: rgba(42,21,9,0.3);">
                      You received this because you subscribed at corradosrestaurant.com<br />
  ...
  private async sendWelcomeEmail(subscriber: Subscriber): Promise<void> {
    ...
    const html = this.buildEmailTemplate({
      preheader: "Welcome to the Corrado's Restaurant Newsletter!",
      heading: "Welcome to Corrado's Restaurant!",
      title: "You're on the list!",
      description:
        "Thanks for subscribing to the Corrado's Restaurant newsletter! You'll be the first to hear about our latest events, specials, and everything happening at Corrado's Restaurant - family-owned Italian dining.",
    ...
    await this.sendMail(
      subscriber.email,
      "Welcome to the Corrado's Restaurant Newsletter! 🍺",
      html,
    );
  }
